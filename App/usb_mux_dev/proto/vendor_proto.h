...
typedef enum {
    VP_BLE_GET_CAP        = 0x01,
    VP_BLE_SET_SCAN_PARAM = 0x02,
    VP_BLE_SCAN_START     = 0x03,
    VP_BLE_SCAN_STOP      = 0x04,
    VP_BLE_CONNECT        = 0x05,
    VP_BLE_DISCONNECT     = 0x06,
    VP_BLE_GET_CONN_STATE = 0x07,
    VP_BLE_DISCOVER_SERVICES        = 0x08,
    VP_BLE_DISCOVER_CHARACTERISTICS = 0x09,
    VP_BLE_DISCOVER_DESCRIPTORS     = 0x0A,
    VP_BLE_READ                     = 0x0B,
    VP_BLE_WRITE_REQ                = 0x0C,
    VP_BLE_WRITE_CMD                = 0x0D,
    VP_BLE_SUBSCRIBE                = 0x0E,
    VP_BLE_UNSUBSCRIBE              = 0x0F,
    VP_BLE_EXCHANGE_MTU             = 0x10,
    VP_BLE_READ_RSSI                = 0x11,
    VP_BLE_UPDATE_CONN_PARAM        = 0x12,
    VP_BLE_EVT_SCAN_RSP   = 0x80,
    VP_BLE_EVT_CONN_STATE = 0x81,
    VP_BLE_EVT_SERVICE_FOUND = 0x82,
    VP_BLE_EVT_CHAR_FOUND    = 0x83,
    VP_BLE_EVT_DESC_FOUND    = 0x84,
    VP_BLE_EVT_READ_RESULT   = 0x85,
    VP_BLE_EVT_WRITE_RESULT  = 0x86,
    VP_BLE_EVT_NOTIFY_DATA   = 0x87,
    VP_BLE_EVT_INDICATE_DATA = 0x88,
    VP_BLE_EVT_RSSI_RESULT   = 0x89,
} vp_ble_opcode_t;
